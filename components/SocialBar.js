...
export default function SocialBar() {
  return (
    <div className="md:fixed md:bottom-0 md:left-5">
      <div className="grid grid-cols-5 md:block justify-items-center max-w-fit md:max-w-none mx-auto">
        <div className="py-2 px-2 hover:pt-1 hover:pb-3">
        ...
        <div className="py-2 px-2 hover:pt-1 hover:pb-3">
          <a href={socialLinks.instagram}>
            <Image src="/svg/instagram.svg" width="24" height="24" />
          </a>
        </div>
        <div className="py-2 px-2 hover:pt-1 hover:pb-3">
